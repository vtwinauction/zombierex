    ...
    <div className="pb-56">
        ...
        <div className="mt-2 grid grid-cols-4 gap-2">
          {photos.map((p, i) => (
            ...
            >
              ...
              {i === 0 && (
                <span
                  className="absolute bottom-1 left-1 mono-tag px-1"
          ...
          {photos.length < 15 && (
            <label
              className="tap flex aspect-square cursor-pointer items-center justify-center border border-dashed"
      ...
      <Section title="ESSENTIALS">
        <Input
          ...
          placeholder="2022 Kawasaki Ninja ZX-6R"
        />
        <TextArea
          label="DESCRIPTION"
          value={form.description}
          onChange={(v: string) => set("description", v)}
          placeholder="History, mods, service records…"
        />
        <Row>
          <Select
            label="CATEGORY *"
        ...
        <Row>
          <Input
            ...
            onChange={(v: string) => set("price_cents", v)}
            placeholder="9500"
          />
          <Select
            label="CURRENCY *"
      ...
      <Section title="VEHICLE DETAILS">
        <Row>
          ...
          <DataListInput
            ...
            listId="model-list"
            options={form.brand ? getAllModels(form.brand) : []}
            placeholder="ZX-6R"
          />
        </Row>
        <Row>
          ...
          <Input
            ...
            onChange={(v: string) => set("mileage_km", v)}
            placeholder="7800"
          />
        </Row>
        <Row>
          <Input
            ...
            onChange={(v: string) => set("engine_cc", v)}
            placeholder="636"
          />
          <Input
            label="COLOR"
        ...
        <Row>
          <Select
            ...
            onChange={(v: string) => set("fuel_type", v)}
      ...
      <Section title="LOCATION">
        <Row>
          ...
          <DataListInput
            ...
            listId="city-list"
            options={getAllCities(form.country)}
            placeholder="Manama"
          />
        </Row>
        <Input
      ...
      {err && (
        <p className="mx-4 mt-4 mono-tag" style={{ color: "#ff6b6b" }}>
          ERR · {err}
        </p>
      )}

      <div
        className="fixed inset-x-0 z-40 border-t p-3"
        style={{
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div
      className="mx-4 mt-6 border p-4 space-y-3"
