...
function AnalyticsPage() {
  ...
  return (
    ...
    >
      <div className="pb-24">
        <div
          className="sticky top-0 z-20 flex items-center gap-3 px-4 py-3 hairline-b"
          ...
          <>
            ...
            >
              ...
              <Stat
                ...
                label="COMMENTS"
                value={fmtNum(data.totals.comments)}
              />
              ...
              <div className="h-64 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <XAxis
                      dataKey="date"
                      tick={{ fill: "var(--color-titanium)", fontSize: 10 }}
            ...
            <Section title="TOP PERFORMING CONTENT">
              <div className="space-y-2">
                {data.top_posts.map((p: any, idx: number) => (
                  ...
                  >
                    <span
                      className="mono-num w-6 text-center font-bold"
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mono-tag mt-0.5" style={{ color: "var(--color-titanium)" }}>
                        {fmtNum(p.views)} views · {fmtNum(p.likes)} likes · {fmtNum(p.comments)}{" "}
                        comments
                      </p>
                    </div>
                  </div>
            ...
            >
              ...
              <div className="mt-3 grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="mono-num text-xl font-bold" style={{ color: "var(--color-ink)" }}>
                    {fmtNum(data.profile.subscribers_count ?? 0)}
                  </p>
                </div>
              </div>
            </div>
