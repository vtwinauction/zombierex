...
export const Route = createFileRoute("/_authenticated/security")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Manage devices, two-factor authentication, and your account data.",
      },
    ],
  }),
  ...
  async function onDeleteRequest() {
    if (
      !(await confirmDialog({
        ...
        description: "This cannot be undone. Our team will process within 30 days.",
        destructive: true,
    ...
    >
      <main className="mx-auto max-w-xl px-4 pb-32 pt-4">
        ...
        <Section
          ...
          hint="Add a one-time code from an authenticator app."
        >
          {mfaEnabled ? (
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                disabled={busy === "mfa-off"}
                className="tap px-3 py-1.5 text-xs"
                style={btnGhost}
              >
                Disable
              </button>
            ...
            <div className="space-y-3">
              ...
              {mfaSecret && (
                <p className="text-[11px] opacity-70">
                  Or enter this key manually: <code>{mfaSecret}</code>
                </p>
              )}
              <input
                value={mfaCode}
              ...
              {devices.map((d) => (
                ...
                >
                  ...
                  <button
                    ...
                    disabled={busy === d.id}
                    className="tap ml-2 shrink-0 px-2 py-1 text-[11px]"
                    style={btnGhost}
                  >
                    {busy === d.id ? "…" : "Revoke"}
                  </button>
        ...
        <Section title="Your data" hint="Download a copy of everything you've created.">
          <div className="flex gap-2">
            ...
            <a href="/settings" className="tap px-3 py-2 text-sm" style={btnGhost}>
              Privacy settings
            </a>
          </div>
        </Section>
        ...
        <Section
          ...
          hint="Removes your profile and content after review. Cannot be undone."
        >
          <button
