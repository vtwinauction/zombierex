  ...
  head: () => ({
    meta: [
      { title: "Group Rides · ZOMBIEREX" },
      {
        name: "description",
        content:
          "Start or join a live group ride and see everyone's position on the map in real time.",
      },
    ],
  }),
  component: GroupHub,
        ...
        <section className="px-4 pt-5">
          <div className="rounded-2xl border border-line bg-paper-0 p-4">
            <div className="mb-2 flex items-center gap-2">
              ...
              <span className="mono-caps text-[10px] font-bold tracking-wider text-ink-3">
                START A NEW RIDE
              </span>
            </div>
            <input
        ...
        <section className="px-4 pt-6">
          ...
          {mine.data && mine.data.length > 0 ? (
                  ...
                  >
                    <div>
                      ...
                      <div className="text-[11px] text-ink-3">
                        <span style={{ fontFamily: "var(--font-mono)" }}>{r.join_code}</span> ·{" "}
                        {r.status}
                      </div>
                    </div>
                    {r.status === "active" ? (
            ...
            <p className="text-xs text-ink-3">
              No rides yet. Start one above and share the code with friends.
            </p>
          )}
        </section>
      </div>
