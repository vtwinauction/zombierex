...
export const Route = createFileRoute("/_authenticated/settings/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Manage your ZOMBIEREX account, privacy, notifications and app preferences.",
      },
...
const SECTIONS: Array<{
  ...
  title: string;
  hint: string;
  items: Array<{ label: string; hint?: string; kind: string }>;
}> = [
  {
    id: "account",
    title: "Account",
    hint: "Your profile and sign-in details",
    items: [
  ...
  },
  {
    id: "privacy",
    title: "Privacy",
    hint: "Who can see and contact you",
    items: [
      {
      ...
      },
      {
        ...
        hint: "Choose who can send you direct messages",
        kind: "select-messages",
      },
      { label: "Blocked people", hint: "Manage users you have blocked", kind: "blocked" },
      {
        label: "Content you see",
        hint: "Muted words and sensitive content",
        kind: "content-prefs",
      },
    ],
  },
  {
    ...
    items: [
      {
        label: "App Lock",
        hint: "Require FaceID, TouchID or fingerprint to open the app",
        kind: "app-lock",
      },
      {
        label: "Two-step verification",
        hint: "Add an extra layer of security when signing in",
        kind: "twofa",
      },
      {
        label: "Where you're signed in",
        hint: "Devices currently using your account",
        kind: "sessions",
      },
      {
        label: "Recent sign-in activity",
        hint: "Review new logins to your account",
        kind: "login-activity",
      },
    ],
  },
  {
    ...
    items: [
      ...
      { label: "Email notifications", hint: "Updates sent to your inbox", kind: "toggle-email" },
      {
        ...
        hint: "Choose which activity notifies you",
        kind: "notif-prefs",
      },
    ],
  },
  {
    ...
    hint: "How the app looks and reads",
    items: [
  ...
  },
  {
    id: "accessibility",
    title: "Accessibility",
    hint: "Make the app easier to use",
    items: [
      {
        label: "Reduce motion",
      ...
      {
        label: "High contrast",
        hint: "Boost contrast for better visibility",
  ...
  },
  {
    id: "data",
    title: "Data & storage",
    hint: "Manage data usage and downloads",
    items: [
      {
        label: "Download quality",
        hint: "Quality for saved photos and videos",
        kind: "select-quality",
      },
      {
        label: "Video autoplay",
        hint: "When videos should play automatically",
        kind: "select-autoplay",
      },
      { label: "Clear cache", hint: "Free up space on your device", kind: "clear-cache" },
      {
        label: "Download your data",
        hint: "Get a copy of your ZOMBIEREX information",
        kind: "download-data",
      },
    ],
  },
  {
    id: "support",
    title: "Help & about",
    hint: "Support, legal and app info",
    items: [
      {
        label: "How to use ZOMBIEREX",
        hint: "A tour of every page, setting and option",
        kind: "guide",
      },
  ...
  return (
    <div className="pb-24">
      <header className="px-5 pt-6">
        <Link to="/profile" className="mono-tag" style={{ color: "var(--color-titanium)" }}>
          ← Back to profile
        </Link>
      ...
      <div className="mt-6 space-y-2 px-3">
          ...
          >
            ...
            >
              <span className="min-w-0">
                ...
                <span className="mt-0.5 block text-[12px]" style={{ color: "var(--color-silver)" }}>
                  {s.hint}
                </span>
              </span>
        ...
        <section className="mt-6 space-y-2">
          <button
            onClick={signOut}
            className="tap w-full rounded-lg px-4 py-3 text-left text-[13px]"
            style={{
          ...
          <p className="mono-tag pt-4 text-center" style={{ color: "var(--color-silver)" }}>
            ZOMBIEREX · v1.0 · build “Signal”
          </p>
        </section>
      </div>
    </div>
...
function SettingRow({
  ...
  if (route) {
    return (
      ...
      >
        ...
        <span className="mono-tag ml-3 shrink-0" style={{ color: "var(--color-titanium)" }}>
          OPEN ›
        </span>
      </Link>
    );
  ...
  const control = (() => {
    switch (it.kind) {
      case "toggle-private":
        return <Toggle checked={prefs.private} onChange={(v) => update("private", v)} />;
      case "toggle-motion":
        return (
          <Toggle checked={prefs.reducedMotion} onChange={(v) => update("reducedMotion", v)} />
        );
      case "toggle-contrast":
        return <Toggle checked={prefs.highContrast} onChange={(v) => update("highContrast", v)} />;
      case "toggle-large-text":
        return <Toggle checked={prefs.largeText} onChange={(v) => update("largeText", v)} />;
      case "toggle-push":
        return (
          <Toggle
      ...
      case "select-messages":
        return (
          <Select
            ...
            onChange={(v) => update("allowMessages", v as Prefs["allowMessages"])}
            options={[
              ["everyone", "Everyone"],
              ["followers", "Followers"],
              ["none", "No one"],
      ...
      case "select-quality":
        return (
          <Select
            ...
            onChange={(v) => update("downloadQuality", v as Prefs["downloadQuality"])}
            options={[
              ["auto", "Auto"],
              ["high", "High"],
      ...
      case "select-autoplay":
        return (
          <Select
            value={prefs.autoplay}
            onChange={(v) => update("autoplay", v as Prefs["autoplay"])}
            options={[
              ["always", "Always"],
              ["wifi", "Wi-Fi only"],
              ["never", "Never"],
