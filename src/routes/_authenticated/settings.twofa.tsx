...
export const Route = createFileRoute("/_authenticated/settings/twofa")({
  head: () => ({
    meta: [
      { title: "Two-step verification · Settings · ZOMBIEREX" },
      {
        name: "description",
        content: "Add an extra layer of security when signing in with an authenticator app.",
      },
    ],
  }),
  component: TwoFAPage,
...
function TwoFAPage() {
  ...
  const verify = async () => {
    ...
    setEnroll(null);
    setCode("");
    setMsg("Two-step verification enabled.");
    load();
  };
  ...
  return (
    <SettingsScreen
      ...
      subtitle="Use an authenticator app like 1Password, Authy or Google Authenticator."
    >
      <div className="space-y-3">
        ...
        {enroll && (
          <Card>
            ...
            />
            <p
              className="mono-tag mt-3 break-all text-center"
