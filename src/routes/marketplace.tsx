  ...
  head: () => ({
    meta: [
      { title: "Marketplace · ZOMBIEREX" },
      {
        name: "description",
        content:
          "Buy and sell motorcycles, cars, parts, gear and services in the ZOMBIEREX community.",
      },
    ],
  }),
      ...
      <div className="pb-24" style={{ background: "var(--color-paper-1)" }}>
        ...
        <div className="flex items-end justify-between gap-3 px-4 pt-6">
          <div className="min-w-0">
            ...
            <h1
              className="serif mt-1 text-4xl italic leading-none"
        ...
        <div className="px-4 pt-4">
          ...
          <div className="mt-2 grid grid-cols-3 gap-2">
            ...
            <SelectField
              ...
              options={[
                { value: "", label: "All" },
                ...LISTING_CATEGORIES.map((c) => ({ value: c, label: CAT_LABEL[c] ?? c })),
              ]}
            />
            <SelectField
              label={
            ...
            >
              <div className="grid grid-cols-2 gap-2">
                ...
                <SelectField
                  ...
                  options={[
                    { value: "", label: "Any" },
                    ...LISTING_CONDITIONS.map((c) => ({ value: c, label: c.replace("_", " ") })),
                  ]}
                />
              </div>
              <button
...
function SelectField({
  ...
  return (
    <label className="block">
      <span className="mono-tag font-bold" style={{ color: "var(--color-titanium)" }}>
        {label}
      </span>
      <div
...
function Badge({
  ...
  tone?: "neon" | "dark" | "light" | "red";
}) {
  const styles: React.CSSProperties =
    tone === "neon"
      ? { background: "var(--color-neon)", color: "#0a0a0a" }
      : tone === "dark"
        ? { background: "rgba(10,10,10,0.85)", color: "#fff", backdropFilter: "blur(4px)" }
        : tone === "red"
...
function FeaturedCard({ listing }: { listing: any }) {
  const l = listing;
  return (
    <Link to="/marketplace/$id" params={{ id: l.id }} className="block px-4 pt-5">
      <article
      ...
      >
        ...
        <div className="p-4">
          ...
          <h2
            className="serif mt-1 text-2xl italic leading-tight"
            style={{ color: "var(--color-ink)" }}
          >
            {l.title}
          </h2>
          <div className="mt-2 flex items-baseline justify-between gap-3">
            ...
            {l.city && (
              <p
                className="mono-tag inline-flex items-center gap-1 truncate"
          ...
          {l.condition && (
            <div className="mt-3 flex flex-wrap items-center gap-1.5">
              ...
              {l.transmission && l.transmission !== "na" && (
                <Chip>{String(l.transmission).toUpperCase()}</Chip>
              )}
            </div>
          )}
          ...
          {l.seller && (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p
                  className="mono-tag inline-flex items-center gap-1"
                  style={{ color: "var(--color-titanium)" }}
                >
              ...
              <span className="mono-tag font-bold" style={{ color: "var(--color-neon-deep)" }}>
                VIEW ▸
              </span>
            </div>
          )}
  ...
  return (
    ...
    >
      ...
      <div className="p-2.5">
        ...
        <p
          className="mt-0.5 line-clamp-2 min-h-[2.4em] text-[13px] font-semibold leading-tight"
          style={{ color: "var(--color-ink)" }}
        >
          {l.title}
        </p>
        ...
        <div className="mt-1 flex items-center justify-between gap-1">
          {l.condition && (
            <span
              className="mono-tag truncate text-[9px]"
              style={{ color: "var(--color-titanium)" }}
            >
          ...
          {l.city && (
            <span
              className="mono-tag inline-flex items-center gap-0.5 truncate text-[9px]"
              style={{ color: "var(--color-titanium)" }}
            >
