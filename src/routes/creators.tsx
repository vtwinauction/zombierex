...
export const Route = createFileRoute("/creators")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Trending builders, racers, photographers and clubs on ZOMBIEREX.",
      },
    ],
  }),
  ...
  return (
    <PullToRefresh onRefresh={() => refetch()}>
      <div className="pb-24">
        ...
        <div
          className="no-scrollbar mt-4 flex overflow-x-auto border-y"
        ...
        <div
          className="no-scrollbar flex gap-2 overflow-x-auto px-4 py-3 border-b"
          style={{ borderColor: "var(--color-hair)" }}
        >
          <button
          ...
          <Link to="/creator/$id" params={{ id: featured.user_id }} className="block px-4 pt-4">
            ...
            >
              <div className="relative h-52 w-full">
                ...
                />
                <span
                  className="absolute left-3 top-3 mono-tag font-bold"
                  style={{ background: "var(--color-neon)", color: "#0a0a0a", padding: "4px 8px" }}
                >
                  FEATURED CREATOR
                </span>
...
function CreatorRow({ c }: { c: any }) {
  return (
    <Link to="/creator/$id" params={{ id: c.user_id }} className="block">
      <article
        className="grid grid-cols-[64px_1fr_auto] items-center gap-3 border p-3"
      ...
      >
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            ...
            {c.is_verified && (
              <span
                className="mono-tag font-bold px-1"
          ...
          {c.tagline && (
            <p className="mt-1 truncate text-xs" style={{ color: "var(--color-silver)" }}>
              {c.tagline}
            </p>
          )}
        </div>
