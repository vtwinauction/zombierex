  ...
  public: {
    Tables: {
      ...
      saved_collection_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "saved_collection_items_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
    ...
    Enums: {
      ...
      ad_placement:
        ...
        | "communities"
        | "search";
      ad_status: "draft" | "pending" | "active" | "paused" | "completed" | "rejected";
      app_role:
        | "super_admin"
        | "admin"
        | "moderator"
      ...
      fee_scope: "default" | "category" | "seller" | "seller_type" | "country" | "promo";
      ledger_account:
        | "platform_revenue"
        | "seller_payable"
        | "processor_fees"
      ...
      listing_category:
        ...
        | "electronics"
        | "services";
      listing_condition: "new" | "like_new" | "used" | "for_parts" | "refurbished";
      ...
      listing_transmission: "manual" | "automatic" | "semi_auto" | "cvt" | "dct" | "na";
      notification_kind:
        | "like"
        | "comment"
        | "follow"
      ...
      route_poi_kind: "hotel" | "food" | "fuel" | "scenic" | "repair" | "viewpoint" | "custom";
...
export const Constants = {
  public: {
    Enums: {
      ...
      ad_placement: ["feed", "reels", "stories", "explore", "marketplace", "communities", "search"],
      ad_status: ["draft", "pending", "active", "paused", "completed", "rejected"],
      app_role: [
        "super_admin",
        "admin",
      ...
      route_visibility: ["public", "private"],
      txn_kind: ["order", "tip", "creator_subscription", "plan", "ad", "other"],
      txn_status: ["pending", "succeeded", "failed", "refunded", "partially_refunded", "cancelled"],
    },
  },
} as const;
