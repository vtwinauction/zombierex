...
export const MUSIC_LIBRARY: MusicTrack[] = [
  ...
  { id: "t10", title: "Torque Poet",       artist: "REX/Audio",   duration: 366, bpm: 124, mood: "hype",       category: "garage",    url: SH(10), coverGradient: "linear-gradient(135deg,#0f0f10,#212423 55%,#c6ff3d)" },
